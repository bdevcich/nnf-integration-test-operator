...
const (
	controllerTypeManager = "manager"
	controllerTypeHelper  = "helper"
)
...
func main() {
	...
	flag.StringVar(&controllerType, "controller", controllerTypeManager, "The controller type to run {manager, helper}.")
	opts := zap.Options{
		Development: true,
	}
	...
	options := ctrl.Options{
		...
		LeaderElectionID:       "4ccf3276.cray.hpe.com",
